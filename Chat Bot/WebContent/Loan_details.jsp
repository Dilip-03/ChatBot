     ...
     <%
      ...
      %>
        ...
        <ul class="pagination justify-content-center" style="margin:20px 0">
		  ...
		  <li class="page-item active"><a class="page-link" href="Loan_details.jsp">Add Loan</a></li>
        ...
        <div class="container">
	       <form action="Loan" method="Post">
	            ...
	            <div class="input-group" style="margin-top:10px;">
				  <div class="input-group-prepend">
				    <span class="input-group-text">Loan No</span>
				  </div>
				  <input type="number" aria-label="Account No" class="form-control" name="loanno" required>
				</div>
				<div class="input-group" style="margin-top:10px;">
				  <div class="input-group-prepend">
				    <span class="input-group-text">Loan Type</span>
				  </div>
				  <input type="text" aria-label="Branch" class="form-control" name="loanty" required>
				</div>
				<div class="input-group" style="margin-top:10px;">
				  <div class="input-group-prepend">
				    <span class="input-group-text">Due Date</span>
				  </div>
				  <input type="Date" aria-label="Type" class="form-control" name="due" required>
				</div>
				<div class="input-group" style="margin-top:10px;">
				  <div class="input-group-prepend">
				    <span class="input-group-text">Payment_amount</span>
				  </div>
				  <input type="number" aria-label="Balance" class="form-control" name="payment" required>
				</div>
